  ...
  return (
    <section className="min-h-screen min-w-screen flex flex-col items-center text-white overflow-clip">
      ...
      <main className="flex flex-col border-white border-1 rounded-xl w-10/12 mt-8 space-y-8 p-4">
        ...
        <div className="w-full py-8 mx-auto flex flex-col justify-center items-center">
          <img className="rounded-2xl" src="/assets/image/Anatomy.png" alt="" />
        </div>
        <h2 className="cinzel text-2xl md:text-4xl mt-4">
        ...
        <div className="flex flex-col space-y-6 montserrat">
          ...
          <table class="w-full md:w-1/2 mx-auto border-collapse text-center">
            <thead>
              <tr>
                <th className="border-b-slate-700 border border-x-0 border-t-0">Atributo</th>
                <th className="border-b-slate-700 border border-x-0 border-t-0">Modificador</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border-b-slate-700 border border-x-0">3</td>
                <td className="border-b-slate-700 border border-x-0">-2</td>
              </tr>
              <tr>
                <td className="border-b-slate-700 border border-x-0">4 a 6</td>
                <td className="border-b-slate-700 border border-x-0">-1</td>
              </tr>
              <tr>
                <td className="border-b-slate-700 border border-x-0">7 a 13</td>
                <td className="border-b-slate-700 border border-x-0">0</td>
              </tr>
              <tr>
                <td className="border-b-slate-700 border border-x-0">14 a 17</td>
                <td className="border-b-slate-700 border border-x-0">+1</td>
              </tr>
              <tr>
                <td className="border-b-slate-700 border border-x-0">18</td>
                <td className="border-b-slate-700 border border-x-0">+2</td>
              </tr>
            </tbody>
          </table>
          ...
          <div className="w-full mt-4 mx-auto flex items-center justify-center">
            <img className="rounded-2xl opacity-25" src="/assets/image/strength.png" alt="" />
          </div>
          <h3 className="text-2xl">
            Destreza
          </h3>
          ...
          <div className="w-full mt-4 mx-auto flex items-center justify-center">
            <img className="rounded-2xl opacity-25" src="/assets/image/dexterity.png" alt="" />
          </div>
          <h3 className="text-2xl">
            Constitucion
          </h3>
          ...
          <div className="w-full mt-4 mx-auto flex items-center justify-center">
            <img className="rounded-2xl opacity-25" src="/assets/image/constitution.png" alt="" />
          </div>
          <h3 className="text-2xl">
            Inteligencia
          </h3>
          ...
          <div className="w-full mt-4 mx-auto flex items-center justify-center">
            <img className="rounded-2xl opacity-25" src="/assets/image/intelligence.png" alt="" />
          </div>
          <h3 className="text-2xl">
            Sabiduria
          </h3>
          ...
          <div className="w-full mt-4 mx-auto flex items-center justify-center">
            <img className="rounded-2xl opacity-25" src="/assets/image/wisdom.png" alt="" />
          </div>
          <h3 className="text-2xl">
            Carisma
          </h3>
          ...
          <div className="w-full mt-4 mx-auto flex items-center justify-center">
            <img className="rounded-2xl opacity-25" src="/assets/image/charisma.png" alt="" />
          </div>
