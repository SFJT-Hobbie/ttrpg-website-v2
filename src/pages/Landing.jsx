...
const Landing = () => {
  ...
  return (
    <motion.section
      ...
      animate="visible"
      exit="exit"
      className="min-h-screen min-w-screen flex flex-col text-white"
    >
      <motion.div variants={itemVariants} className="top-0 mx-auto mt-4 text-center">
        <h1 className="cinzel text-5xl md:text-7xl landing-title">Aristilia</h1>
      </motion.div>
      <motion.div variants={itemVariants} className="my-auto flex flex-col md:flex-row justify-end items-center">
        <motion.div variants={itemVariants} className="flex flex-col items-center md:items-end space-y-8 pr-4">
          <motion.h2 variants={itemVariants} className="cinzel text-3xl md:text-5xl tracking-widest pb-4">
            Eldra'Kazhan
          </motion.h2>
          <motion.div variants={itemVariants}>
            <ul className="text-xl md:text-2xl text-center md:text-right space-y-8 garamond tracking-widest">
